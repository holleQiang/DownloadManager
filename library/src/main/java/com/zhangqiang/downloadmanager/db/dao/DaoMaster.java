...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        FTPTaskEntityDao.createTable(db, ifNotExists);
        HttpDefaultTaskEntityDao.createTable(db, ifNotExists);
        ...
        TSTaskEntityDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        FTPTaskEntityDao.dropTable(db, ifExists);
        HttpDefaultTaskEntityDao.dropTable(db, ifExists);
        ...
        TSTaskEntityDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(FTPTaskEntityDao.class);
        registerDaoClass(HttpDefaultTaskEntityDao.class);
        ...
        registerDaoClass(TSTaskEntityDao.class);
    }
