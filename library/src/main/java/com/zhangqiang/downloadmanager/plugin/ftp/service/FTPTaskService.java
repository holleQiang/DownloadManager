package com.zhangqiang.downloadmanager.plugin.ftp.service;
...
public class FTPTaskService {
    ...
    private FTPTaskEntity toEntity(FTPTaskBean ftpTaskBean) {
        ...
        ftpTaskEntity.setSaveFileName(ftpTaskBean.getSaveFileName());
        ...
        ftpTaskEntity.setContentType(ftpTaskBean.getContentType());
        ftpTaskEntity.setPriority(ftpTaskBean.getPriority());
        return ftpTaskEntity;
    }

    public List<FTPTaskBean> getFtpTaskBeans() {
        ...
        if (entities != null) {
            ...
            for (FTPTaskEntity entity : entities) {
                ...
                ftpTaskBean.setSaveFileName(entity.getSaveFileName());
                ...
                ftpTaskBean.setContentType(entity.getContentType());
                ftpTaskBean.setPriority(entity.getPriority());
