...
public class Listeners {
    ...
    private List<HttpTaskInfo.Listener> listenerList;

    synchronized void addListener(HttpTaskInfo.Listener listener) {
    ...
    synchronized  void removeListener(HttpTaskInfo.Listener listener) {
        if (listenerList == null) {
            return;
        }
