...
import com.zhangqiang.downloadmanager2.task.OnTaskFailListener;
...
public class HttpDownloadTask extends AbstractHttpDownloadTask {
    ...
    public HttpDownloadTask(String saveDir,
                            ...
                            String saveFileName) {
        super(saveDir, targetFileName, createTime, status, errorMessage, url, resourceInfo, currentLength);
        this.context = context;
        this.threadSize = threadSize;
