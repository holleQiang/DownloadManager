...
import com.zhangqiang.downloadmanager.task.http.engine.okhttp.OKHttpClients;
import com.zhangqiang.downloadmanager.task.http.engine.okhttp.OkHttpResponse;
...
public class HttpPartDownloadTask extends AbstractHttpDownloadTask {
    ...
    public HttpPartDownloadTask(String saveDir, String targetFileName, long createTime, Status status, String errorMessage, String url, ResourceInfo resourceInfo, long initialLength, Context context, long startPosition, long endPosition) {
        super(saveDir, targetFileName, createTime, status, errorMessage, url, resourceInfo, initialLength);
        this.context = context;
        this.startPosition = startPosition;
        this.endPosition = endPosition;
    }
